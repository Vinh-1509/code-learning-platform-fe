...
export function LoginForm({ onSubmit, loading, error }: LoginFormProps) {
  ...
  return (
    <>
      <AuthLoadingOverlay isVisible={!!loading} messageType="login" />
      <form
          ...
          <Field className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                required
                onChange={handleChange}
                className="font-medium bg-[#f5f8ff] border border-slate-200/50 pl-4 lg:pl-10 pr-10 h-12 focus-visible:ring-primary/20 focus-visible:border-primary rounded-2xl"
              />
              <button
                type="button"
