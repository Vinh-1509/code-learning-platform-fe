...
- Đối với BE (TypeScript + NestJS hoặc Express.js): Repo phải chạy được, có một GET endpoint cơ bản có thể gọi được ở localhost (có thể demo bằng Postman), và đã có thể kết nối thành công với Database (GET endpoint có thể trả về data được tạo sẵn trong database)
  Đối với Database (MongoDB): Được khởi tạo với MongoDB Atlas, và có 1 collection
